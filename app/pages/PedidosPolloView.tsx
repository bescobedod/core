...
import { getPedidosPos, getComparativoStockPollo, enviarTransferenciaPollo, previsualizarTicketPollo, firmarTicketPollo, previsualizarResumenRutaPollo, previsualizarQrsRutaPollo, previsualizarReporteDetallePollo } from "../api/PedidoPosApi";
...
function PedidosPolloViewCompleta() {
  ...
  const handleGenerarReporte = async () => {
    ...
    try {
      const url = await previsualizarReporteDetallePollo(fechaElegida);
      setReporteUrl(url);
