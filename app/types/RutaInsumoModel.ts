...
export interface TiendaRutaInsumos {
  id: string;
  ruta_id: string;
  id_tienda_simphony: string;
...
export interface CrearRutaInsumosPayload {
  nombre_ruta: string;
  whs_code_destino: string;
}

export interface AsignarTiendaRutaInsumosPayload {
  ruta_id: string;
  id_tienda_simphony: string;
  id_tienda_pdv: number | null;
  codigo_tienda: string | null;
...
export interface CandadoRutaInsumos {
  id: string;
  alcance: string;
  ruta_id: string;
  fecha: string;
